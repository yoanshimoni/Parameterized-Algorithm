...
# implement the second algorithm (runtime O(1.6181^k * (n + m)))


def run_vertex_cover_alg_2(graph, k):
  if k < 0:
    return False
  ...
  if isolated_vertices:
    ...
    return run_vertex_cover_alg_2(graph_minus_v, k)
  ...
  if degree_one_vertices:
    ...
    return run_vertex_cover_alg_2(graph_minus_u, k - 1)
  ...
  return run_vertex_cover_alg_2(graph_minus_v, k - 1) or \
         run_vertex_cover_alg_2(graph_minus_neighbors_of_v, k - len(neighbors_of_chosen_vertex))
